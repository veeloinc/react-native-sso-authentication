...
export const google = {
    ...
    client_secret: '87bg-4E6lD3iUHI9kwR_Z1w2v',
...
export default {
  ...
  google: {
    token: function (code) {
      let url = `${google.oauth_token}?grant_type=authorization_code&client_id=${google.client_id}&client_secret=${google.client_secret}&redirect_uri=${google.redirect_uri}`,
          opt = {
            method: 'post',
            headers: {
